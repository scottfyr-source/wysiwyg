        ...
        if tray_event == 'Update Apps':
            ...
            if u_event == "Ok":
                ...
                if u_values.get("-UPDATE-WYSIWYG-"):
                    installer_path = r"C:\Supergirl\Tools\FYRTools\WYSIWYG\INSTALL_WYSIWYG.exe"
                elif u_values.get("-UPDATE-WYSICHAT-"):
                    installer_path = r"C:\Supergirl\Tools\FYRTools\WysiChat\LocalVersion\INSTALL_WYSICHAT.exe"
