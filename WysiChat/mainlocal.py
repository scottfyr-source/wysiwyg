...
# --- SHARED_PATH = r"\\BATMAN\SupergirlNew\Tools\FYRTools\Wysichat"
SHARED_PATH = r"C:\FYRToolS\Wysichat"
...
def main():
    ...
    window_icon = resource_path("fyrlogo.png") # Use PNG for Window to prevent TclError
    tray_icon = resource_path("fyrlogo.png")   # Use PNG for Tray as well to prevent TclError
